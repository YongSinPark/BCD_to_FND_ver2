...
# set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { i_value[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
# set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { i_value[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
# set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { i_value[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
# set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { i_value[3]  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
...
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports { i_digit_select[0] }]; #IO_L3P_T0_DQS_AD5P_35 ,Sch=JA7
set_property -dict { PACKAGE_PIN K2  IOSTANDARD LVCMOS33 } [get_ports { i_digit_select[1] }]; #IO_L5P_T0_AD13P_35    ,Sch=JA8
#set_property -dict { PACKAGE_PIN H2  IOSTANDARD LVCMOS33 } [get_ports { JA[6] }]; #IO_L2P_T0_AD12P_35    ,Sch=JA9
set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports { i_enable }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10
